      ...
      <div className="min-h-screen bg-brand-black-rich flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Welcome back to elegance</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-brand-black-rich text-gray-500">or continue with</span>
              </div>
            </div>
          ...
          <p className="text-center text-gray-400 mt-6 text-sm">
            New to NAZAKKAT?{' '}
            <Link to="/register" className="text-brand-gold-500 hover:text-brand-gold-400">
              Create an account
            </Link>
          </p>
        </motion.div>
